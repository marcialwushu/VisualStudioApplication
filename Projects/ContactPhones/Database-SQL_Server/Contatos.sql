...
/****** Object:  Database [AgendaTelefonica]    Script Date: 14/05/2017 21:14:21 ******/
CREATE DATABASE [AgendaTelefonica]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AgendaTelefonica', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\AgendaTelefonica.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'AgendaTelefonica_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\AgendaTelefonica_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [AgendaTelefonica] SET COMPATIBILITY_LEVEL = 130
GO
